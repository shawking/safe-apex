...
!     UPDATE
      IF(RNMN(ISL)>0.)THEN
          WNH3(ISL,ISA)=WNH3(ISL,ISA)+RNMN(ISL)
      ELSE
	      X1=WNO3(ISL,ISA)+RNMN(ISL)
	      IF(X1>0.)THEN
	          WNO3(ISL,ISA)=X1
	      ELSE
	          RNMN(ISL)=-WNO3(ISL,ISA)
	          WNO3(ISL,ISA)=1.E-10
	      END IF
      END IF
      DF1=TLSNA
      ...
      THSCA+APCO2*THPCA)
      SMM(74,MO,ISA)=SMM(74,MO,ISA)+RSPC(ISL,ISA)
      SMS(8,ISL,ISA)=SMS(8,ISL,ISA)+RSPC(ISL,ISA)
      TRSP=TRSP+RSPC(ISL,ISA)      
      VAR(74,ISA)=VAR(74,ISA)+RSPC(ISL,ISA)
