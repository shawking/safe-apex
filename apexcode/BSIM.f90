...
!     , ADDING, AND RESERVOIR COMPONENTS IN PROPER SEQUENCE. 
      ...
      DO IY=1,NBYR ! ANNUAL LOOP                                                               
        ...
        !     SLAP=0.                                                                          
            ...
            !     WRITE(KW(1),906)(ZTP(L),L=1,NBSL(ISA))                                         
              END DO ! COMMAND LOOP
              !WRITE(KW(1),'(A,I4,A,I4,A,I6)')'MO=',MO,'KDA=',KDA,'ICMD=',ICMD
              ! COMPUTE DAILY WATER BALANCE FOR THE WATERSHED
              !SWFB=0.
              !SRFV=0.
              !ADET=0.
              !SDPK=0.
              ...
              !DO ISA=1,MSA
                  !WSA10=10.*WSA(ISA)
                  !SWFB=SWFB+WSA10*(SW(ISA)+GWST(ISA)+SNO(ISA))
                  !SRFV=SRFV+WSA10*VAR(4,ISA)
                  !ADET=ADET+WSA10*VAR(11,ISA)
                  !SDPK=SDPK+WSA10*VAR(71,ISA)
                  !SEVR=SEVR+EVRT(ISA)
              !END DO
              !SSSF=10.*WSA(MSA)*VAR(15,MSA)
              !X1=10.*RWSX*QVOL(IDO)
              !X2=10.*RWSX*RSSF(IDO)
              !DF=SWBX+SRFV-ADET-SDPK-SEVR-X1-X2-SSSF-SWFB
              !SDF=SDF+DF
              !WRITE(KW(1),908)IY,MO,KDA,SWBX,SRFV,ADET,SDPK,&
              !SEVR,X1,X2,WYLD(IDO),SSSF,SWFB,DF,SDF
          !908 FORMAT(5X,'!!!!!',3I4,' SWB=',F10.2,' RFV=',F10.1,' ET=',F10.1,&
              !' DPK=',F10.2,' EVR=',F10.2,' Q=',F10.4,' RSSF=',F10.4,' WYLD=',&
              !F10.4,' SST=',F10.4,' SWF=',F10.2,' DF=',F10.3,' SDF=',F10.3)   
              !SWBX=SWFB
              TAC=TAC+YC(IDO)
              IF(NDP>0)THEN                                                                  
                  ...
                  (1)),QVOL(IDO),X1,YSD(NDRV,IDO),(PSTN(K),QPST(K,IDO),TSPS(K,IDO)&            
                  ,YPST(K,IDO),K=1,NDP)
        !         IF(MSA>1)THEN
        !             QQ=QVOL(IDO)+X1
        !	          YY=YSD(NDRV,IDO)
        ...
        !         END IF
              ...
              SNA15,SNA30,VAR(4,ISA),VAR(10,ISA),VAR(11,ISA),(VAR(K,ISA),&
              ...
              SMMR(14,MO)=SMMR(14,MO)+YN(IDO)+YNOU(IDO)                                                
              SMMR(15,MO)=SMMR(15,MO)+YP(IDO)+YPOU(IDO)                                                
              ...
              DO ISA=1,MSA
                  ...
                  END IF    
                  CALL HSWBLD(X4,VARW(119),VARW(118),X34,X11,X3,X16,X71,X72,&
                  X18,X110,X19,VAR(86,ISA),BSNO(ISA),ESNO,SWBX(ISA),ESW,&
                  BRSV(ISA),RSV(ISA),BGWS(ISA),EGWS,BSALA(ISA),ESALA,ISA,&
                  NBSA,IY,MO,KDA,KW,MSO)
                  SWBX(ISA)=ESW
                  BSNO(ISA)=ESNO
                  BRSV(ISA)=RSV(ISA)
                  BGWS(ISA)=EGWS
              ...
              IF(KFL(44)>0)THEN
                  DO I=1,MSA                                                                     
	                  ...
	                  II=IDOA(I2)
			          I3=II
		              WRITE(KW(44),153)I2,I1,IYR,MO,KDA,(VAR(KD(K),I2),K=1,NKD)
	              END DO
              END IF	                            
              !CALL NCONT(1)                                                               
              ...
              IF(KFL(34)>0.AND.IPD>5)THEN                                                    
	              DO I=1,MSA                                                                          
	                  ...
	                  II=IDOA(I2)
	                  X2=.001*ZOC(I2)
	                  WRITE(KW(34),471)I1,IYR,IDA,WSA(I2),VAR(4,I2),VAR(5,I2),&
                      VAR(6,I2),VAR(18,I2),VAR(10,I2),VAR(11,I2),RZSW(I2),&
                      VAR(16,I2),VAR(71,I2),VAR(13,I2),VAR(15,I2),VAR(72,I2),&
                      VAR(117,I2),VAR(14,I2),VAR(1,I2),VAR(2,I2),VAR(59,I2),&
                      VAR(3,I2),VAR(27,I2),VAR(31,I2),VAR(53,I2),VAR(54,I2),&
                      VAR(55,I2),VAR(56,I2),VAR(57,I2),VAR(43,I2),VAR(42,I2),&
                      VAR(37,I2),VAR(119,I2),VAR(38,I2),VAR(49,I2),VAR(118,I2),&
                      VAR(39,I2),VAR(80,I2),X2,(PCTH(J,II),J=1,NSZ),(PCT(J,II),&
              ...
              DO                                                                         
                  ...
                  DO ISA=1,MSA                                                               
                      ...
                      IF(KFL(40)>0)THEN
                          ...
                          END DO
                          WRITE(KW(40),155)NBSA(ISA),IYR,MO1,SMM(4,MO1,ISA),SMM(13,MO1,ISA),&
                          SMM(117,MO1,ISA),SMM(16,MO1,ISA),RST0(ISA),(CPNM(LY(IRO(ISA),J,ISA)),&
                          ...
                          BN(3,LY(IRO(ISA),J,ISA)),YLX(J),SMM(141,MO1,ISA),J=1,NCP(IRO(ISA),ISA))
                          DO J=1,NCP(IRO(ISA),ISA)
                              YLX(J)=ZTX(J)
                          END DO                    
                      END IF                                                                                    
                ...
                !     PRINTOUT ANNUAL                                                                
                  ...
                  770 ZTX(1)=ZTX(1)+SMY(11,ISA)*WSAX
	                  ...
	                  ZTX(36)=ZTX(36)+SMY(144,ISA)*WSAX                                                          
	                  ZTX(37)=ZTX(37)+SMY(145,ISA)*WSAX
                      XX=NPSF(ISA)                                                                  
                      ...
                      820 VALF1(ISA)=VALF1(ISA)+VAL1+VAL2
                        ...
                        !     PRINTOUT CROP ANNUAL                                                           
                          ...
                          IF(KFL(24)>0)THEN
                              ...
                              YLD2(J,ISA),X3,(SFCP(I,J,ISA),I=1,7),ZNMN(ISA),&               
                              ZPML(ISA),PDPLC(ISA),X2,OCPD(ISA),RSD(LD1,ISA),ARSD(ISA),&
                              VIR(J,ISA),FRTN(J,ISA),FRTP(J,ISA),SMY(54,ISA),SMY(55,ISA),&
                              SMY(53,ISA),SMY(57,ISA),SMY(56,ISA),SMY(144,ISA),SMY(145,ISA)
                          END IF                         
          ...
          (15),ZTX(3),YTP(9),(ZTX(I),I=19,28),ZTX(32),ZTX(33),ZTX(34),ZTX&
          (35),ZTX(30),ZOC(1),ZTX(29),ZTX(36),ZTX(37),YTP(11)
          YTP(1)=SRCH(15,NCMD)
          YTP(2)=SRCH(16,NCMD)
          YTP(3)=SRCH(19,NCMD)
          YTP(4)=SRCH(20,NCMD)
          ...
          IF(KFL(34)>0)THEN
              IF(IPD>2.AND.IPD<6)THEN                                                        
	              DO MO=1,12                                                                          
	                  DO I=1,MSA                                                                         
	                      ...
	                      II=IDOA(I2)
	                      X1=.001*ZOC(I2)	                                                                       
	                      WRITE(KW(34),471)I1,IYR,MO,WSA(I2),SMM(4,MO,I2),&
                          SMM(5,MO,I2),SMM(6,MO,I2),SMM(18,MO,I2),SMM(10,MO,I2),&
                          SMM(11,MO,I2),SMM(120,MO,I2),SMM(16,MO,I2),SMM(71,MO,I2),&
                          SMM(13,MO,I2),SMM(15,MO,I2),SMM(72,MO,I2),SMM(117,MO,I2),&
                          SMM(14,MO,I2),SMM(1,MO,I2),SMM(2,MO,I2),SMM(59,MO,I2),&
                          SMM(3,MO,I2),SMM(27,MO,I2),SMM(31,MO,I2),SMM(53,MO,I2),&
                          SMM(54,MO,I2),SMM(55,MO,I2),SMM(56,MO,I2),SMM(57,MO,I2),&
                          SMM(43,MO,I2),SMM(42,MO,I2),SMM(37,MO,I2),SMM(119,MO,I2),&
                          SMM(38,MO,I2),SMM(49,MO,I2),SMM(118,MO,I2),SMM(39,MO,I2),&
                          SMM(80,MO,I2),X1,(PCTH(J,II),J=1,NSZ),(PCT(J,II),J=1,NSZ),&
              ...
              IF(IPD>0.AND.IPD<3)THEN                                                                         
                  DO I=1,MSA                                                                     
	                  ...
	                  II=IDOA(I2)
	                  X1=.001*ZOC(I2)	                                                                        
                      WRITE(KW(34),859)I1,IYR,IGC,WSA(I2),SMY(4,I2),SMY(5,I2),&
                      SMY(6,I2),SMY(18,I2),SMY(10,I2),SMY(11,I2),RZSW(I2),&
                      SMY(16,I2),SMY(71,I2),SMY(13,I2),SMY(15,I2),SMY(72,I2),&
                      SMY(117,I2),SMY(14,I2),SMY(1,I2),SMY(2,I2),SMY(59,I2),&
                      SMY(3,I2),SMY(27,I2),SMY(31,I2),SMY(53,I2),SMY(54,I2),&
                      SMY(55,I2),SMY(56,I2),SMY(57,I2),SMY(43,I2),SMY(42,I2),&
                      SMY(37,I2),SMY(119,I2),SMY(38,I2),SMY(49,I2),SMY(118,I2),&
                      SMY(39,I2),SMY(80,I2),X1,(YLD1(LY(IRO(I2),J,I2),I2),YLD2&
	          ...
	          DO ISA=1,MSA                                                                    
                  ...
                  DO I=1,NBSL(ISA)                                                             
                      ...
                      SELECT CASE(ISW+1)
                          ...
                          CASE(7)
                              CALL SWRTNNW(CLA(J,ISA),SAN(J,ISA),Y1,BD(J,ISA),X2,X3)
                      END SELECT
                      XY=1.-ROK(J,ISA)*.01                                                         
                      S15(J,ISA)=X2*X1*XY                                                          
                      FC(J,ISA)=X3*X1*XY                                                           
  ...
  153 FORMAT(1X,2I8,1X,3I4,6X,100F10.2)      
  154 FORMAT(1X,2I8,1X,I4,2I2,100F10.4)
  155 FORMAT(I9,1X,I4,I4,1X,5F10.2,5(A10,11F10.2,2F10.4,2F10.2))  
  471 FORMAT('BIGSUB',I4,I9,I5,1X,E9.3,6F10.2,F10.0,13F10.2,5F10.1,&
  ...
  859 FORMAT('BIGSUB',I4,I9,I5,1X,E9.3,6F10.2,F10.0,13F10.2,5F10.1,&
...
! 921 FORMAT(1X,'ANNUAL MANURE BAL'/I3,8D16.8)                                       
  ...
  936 FORMAT(5X,I4,38F10.3,8F10.0,2F10.2,12F10.1)     
