...
!         =12 MULTIPLE WEATHER GEN PARM SELECTOR
      ...
      DO ISA=1,MSA  !SUBAREA LOOP
          ...
          IF(IAZM>0)THEN
              ...
              !write(*,*) 'LOOKING...',HSG  ! MJB added, and statement prints as of 11/21/19
			  WRITE(KW(1),'(T10,A,F8.3)')'AZIMUTH ORIENTATION OF LAND SLOPE (DEGREES CLOCKWISE FROM NORTH)',AZM
              !write(*,*) '...' ! MJB added, and statement prints as of 11/21/19
...
FUNCTION yearLoopStart (p) BIND(C, name='yearLoopStart')
	...
	!!!BSIM HAS TO BE REMOVED HERE IT IS JUST TO TEST
    !!!HERE ADD THE FUNCTION FOR THE START OF THE YEAR LOOP
    !!CALL BSIM
